...
TukeyHSD(Girth.15yr.fit, ordered = TRUE)
```

##

```{r }
plot(TukeyHSD(Girth.15yr.fit, ordered = TRUE))
```
...
print(TukeyHSD(WgtAbvGrnd.15y.fit, ordered = TRUE))
```

##

```{r }
plot(TukeyHSD(WgtAbvGrnd.15y.fit, ordered = TRUE))
```
