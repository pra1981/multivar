...
```{r 06-lec18, fig.height=5.5, fig.width=5.5}
...
```{r 07-lec18, fig.height=5.5, fig.width=5.5}
str(USArrests)
head(USArrests)
...
```{r 08-lec18, fig.height=5.5, fig.width=5.5}
...
```{r 09-lec18, fig.height=5.5, fig.width=7 }
...
```{r 10-lec18, fig.height=5.5, fig.width=5.5}
# specify point type according to species
# specify color by clusters with k = 3
pairs(USArrests, col = cutree(arrests.hc.s, k = 6), pch = 16)
```
